class teacherTemplate{
    ...
    req(p, teacher){
        var title_img_arr = p.loadStrings("./public/img/title_img.txt", function (){
        ...
        var title_txt_arr = p.loadStrings("./public/img/title_text.txt", function () {
        ...
        var subtitle_img_arr = p.loadStrings("./public/img/subtitle_img.txt", function () {
        ...
        var subtitle_txt_arr = p.loadStrings("./public/img/subtitle_text.txt", function () {
        ...
        var step_img_arr = p.loadStrings("./public/img/step_img.txt", function () {
